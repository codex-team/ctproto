...
import { ApiRequest, ApiResponse, ApiUpdate, ApiUploadRequest } from '../../types';
 ...
 */
export const client = new CTProtoClient<AuthorizeMessagePayload, AuthorizeResponsePayload, ApiRequest, ApiResponse, ApiUpdate, ApiUploadRequest>({
